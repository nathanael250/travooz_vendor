...
class RestaurantApprovalNotificationService {
    /**
     * Send approval email to restaurant vendor
     */
            ...
            const html = `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <div style="background-color: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none;">
                        <h2 style="color: #1f2937; margin-top: 0;">Your Restaurant Has Been Approved!</h2>
                        <p style="color: #4b5563; font-size: 16px;">Hi ${name || 'there'},</p>
                        <p style="color: #4b5563; font-size: 16px;">
                            Great news! Your restaurant <strong>${businessName}</strong> has been approved and is now live on Travooz!
                        </p>
                        <p style="color: #4b5563; font-size: 16px;">
                            Customers can now discover and order from your restaurant. You can manage your menu, orders, and settings from your dashboard.
                        </p>
...
Great news! Your restaurant ${businessName} has been approved and is now live on Travooz!
...
© ${new Date().getFullYear()} Travooz. All rights reserved.
            ...
            await EmailService.sendEmail({
                to: email,
                subject: `🎉 Your Restaurant ${businessName} is Now Live on Travooz!`,
                html,
                text
            });

            console.log(`✅ Approval email sent to ${email} for restaurant ${businessName}`);
        } catch (error) {
    ...
    /**
     * Send rejection email to restaurant vendor
     */
        ...
        try {
            const html = `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <div style="background-color: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none;">
                        <h2 style="color: #1f2937; margin-top: 0;">Your Restaurant Submission Needs Updates</h2>
                        <p style="color: #4b5563; font-size: 16px;">Hi ${name || 'there'},</p>
                        <p style="color: #4b5563; font-size: 16px;">
                            Thank you for submitting your restaurant <strong>${businessName}</strong> to Travooz.
                        </p>
                        <p style="color: #4b5563; font-size: 16px;">
...
Thank you for submitting your restaurant ${businessName} to Travooz.
...
© ${new Date().getFullYear()} Travooz. All rights reserved.
            ...
            await EmailService.sendEmail({
                to: email,
                subject: `⚠️ Action Required: Update Your Restaurant Submission`,
                html,
                text
            });

            console.log(`✅ Rejection email sent to ${email} for restaurant ${businessName}`);
        } catch (error) {
