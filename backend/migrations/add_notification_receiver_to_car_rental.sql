...
-- Add notification receiver columns to car_rental_businesses table
...
SELECT 'Migration completed: Added notification receiver columns to car_rental_businesses.';
