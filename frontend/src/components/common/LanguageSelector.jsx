...
const LanguageSelector = ({ compact = false, isDark = false }) => {
  ...
  const selectClasses = isDark
    ? 'bg-gray-700 border border-gray-600 text-white text-xs rounded-md px-2 py-1 focus:outline-none focus:ring-1 focus:ring-indigo-500'
    : 'bg-gray-800 border border-gray-700 text-gray-100 text-xs rounded-md px-2 py-1 focus:outline-none focus:ring-1 focus:ring-indigo-500';
