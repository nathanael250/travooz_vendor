...
export default function StaysDashboard() {
  ...
  // Property not live - layout handles sidebar/header, we just show the message
  // The layout already shows a banner, but we can add additional context here if needed
  // For now, just continue to show dashboard content (layout will handle the banner)

  // Dashboard content only - layout is handled by StaysDashboardLayout
  return (
