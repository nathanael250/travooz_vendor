...
export default function CarRentalLogin() {
      ...
      if (user && token) {
        try {
          ...
          if (carRentalBusinessId) {
            try {
              const status = await carRentalSetupService.getSubmissionStatus(carRentalBusinessId);
              ...
              if (apiMessage.includes('No submission found') || 
                ...
                localStorage.removeItem('car_rental_submission_status');
            ...
            // No car rental business ID - might be stale user data, clear it
            console.log('⚠️ No car rental business ID found. Clearing stale user data...');
            localStorage.removeItem('user');
            localStorage.removeItem('token');
            localStorage.removeItem('auth_token');
          }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Login to car_rental_users table
      ...
      const carRentalBusinessId = result.carRentalBusinessId || localStorage.getItem('car_rental_business_id');
      ...
      if (carRentalBusinessId) {
        ...
        // No car rental business yet - redirect to listing form
        navigate('/car-rental/list-your-car-rental', { replace: true });
      }
    } catch (error) {
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-xl p-8 border" style={{ borderColor: '#dcfce7' }}>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to manage your car rental services</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <button
                  type="button"
                  onClick={() => navigate('/car-rental/forgot-password')}
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <button
                  onClick={() => navigate('/car-rental/list-your-car-rental')}
