...
export default function TaxPaymentStep() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save tax & payment information via API
      await tourPackageSetupService.saveTaxPayment({
        ...formData,
        userId,
      ...
      // Navigate to next setup step (Tour Package Setup - Optional)
      navigate('/tours/setup/tour-package', {
        state: {
          ...location.state,
          businessDetails,
          taxPayment: formData,
  ...
  const handleBack = () => {
    navigate('/tours/setup/business-details', {
      state: {
        ...location.state,
        businessDetails
      }
      ...
      <div className="flex-1 w-full py-8 px-4">
        <div className="max-w-3xl w-full mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-center text-sm font-medium" style={{ color: '#1f6f31' }}>Step 5 of 9: Tax & Payment Information</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4 pt-4 border-t border-gray-200">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Please upload these documents to confirm your business. This helps us verify your account before you can start listing tours.
                </p>

                {renderDocumentUpload(
                  'professionalCertificate',
                  'Professional Certificate / Tour Operator License',
                  'Upload your professional certificate or tour operator license'
                )}
