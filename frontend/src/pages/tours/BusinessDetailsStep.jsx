...
export default function BusinessDetailsStep() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await tourPackageSetupService.saveBusinessDetails({
        ...formData,
        userId,
        email,
        userName
      ...
      // Navigate to next setup step (Tax & Payment)
      ...
      <div className="flex-1 w-full py-8 px-4">
        <div className="max-w-3xl w-full mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-center text-sm font-medium" style={{ color: '#1f6f31' }}>Step 4 of 9: Business Details</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-xl p-8 border" style={{ borderColor: '#dcfce7' }}>
            ...
            <p className="text-gray-600 mb-8">
              Please provide information about your tour business or company.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="businessName" className="block text-sm font-medium text-gray-700 mb-2">
                  Registered Business / Tour Company Name *
                </label>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Minimum 20 characters. Describe your tour services, destinations, and unique offerings.
                </p>
