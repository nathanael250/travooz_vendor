...
export default function AgreementStep() {
  ...
  const tourPackage = location.state?.tourPackage || null;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Submit agreement and finalize setup
      await tourPackageSetupService.submitAgreement({
        userId,
        businessDetails,
        taxPayment,
        tourPackage,
      ...
      <div className="flex-1 w-full py-8 px-4">
        <div className="max-w-3xl w-full mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-center text-sm font-medium" style={{ color: '#1f6f31' }}>Step 8 of 9: Sign Agreement & Submit</p>
          </div>
