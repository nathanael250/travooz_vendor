      ...
      <div className="flex-1 w-full py-8 px-4">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="block md:hidden mb-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium" style={{ color: '#1f6f31' }}>
                  Step 1 Complete: Verify Your Email
                </span>
              ...
              <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                <div 
                  ...
                  style={{ backgroundColor: '#3CAF54', width: '17%' }}
                ></div>
              </div>
            </div>
            ...
            <p className="text-center text-sm font-medium hidden md:block" style={{ color: '#1f6f31' }}>Step 1 Complete: Verify Your Email</p>
          </div>
